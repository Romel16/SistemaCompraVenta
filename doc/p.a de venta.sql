...
CREATE PROCEDURE SP_listarVENTA_01 
@VENT_ID INT
AS
BEGIN
	SELECT        
...
--TODO: Listar Venta
CREATE PROCEDURE SP_listarVENTA_02
@VENT_ID INT
AS
BEGIN
SELECT        
...
usuario ON TM_VENTA.USU_ID = usuario.USU_ID INNER JOIN
...
CREATE PROCEDURE SP_listarVENTA_03  
@SUC_ID INT  
AS  
BEGIN  
 SELECT          
